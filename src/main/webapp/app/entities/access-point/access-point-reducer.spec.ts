...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCESSPOINT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCESSPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCESSPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCESSPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCESSPOINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCESSPOINT actions', async () => {
      const expectedActions = [
        {
