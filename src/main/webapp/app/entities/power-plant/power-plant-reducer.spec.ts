...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POWERPLANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_POWERPLANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POWERPLANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POWERPLANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POWERPLANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POWERPLANT actions', async () => {
      const expectedActions = [
        {
