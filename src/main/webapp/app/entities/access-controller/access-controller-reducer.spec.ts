...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './access-controller.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCESSCONTROLLER_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCESSCONTROLLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCESSCONTROLLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCESSCONTROLLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCESSCONTROLLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCESSCONTROLLER actions', async () => {
      const expectedActions = [
        {
