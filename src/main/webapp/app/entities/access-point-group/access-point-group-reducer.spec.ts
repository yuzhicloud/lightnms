...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './access-point-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCESSPOINTGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCESSPOINTGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCESSPOINTGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCESSPOINTGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCESSPOINTGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCESSPOINTGROUP actions', async () => {
      const expectedActions = [
        {
